# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-01-02 19:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(help_text='Required. 20 characters or less.', max_length=20)),
                ('descripcion', models.TextField(blank=True, help_text='200 characters or less.', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dni', models.CharField(blank=True, help_text='Required. 9 characters. Format: 71254631D.', max_length=9, null=True, validators=[django.core.validators.RegexValidator('^\\d{8}[A-Z]{1}$', 'Enter a valid DNI. Format: 71254631D.')], verbose_name='DNI')),
