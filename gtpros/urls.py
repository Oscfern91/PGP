...
urlpatterns = [
    ...
    url(r'^project/(?P<pk>[0-9]+)/roles/ready/(?P<ready_error>[0,1])/$', views.roles, name='roles_ready_error'),
    
    url(r'^project/(?P<pk>[0-9]+)/actividades/$', views.activities, name='actividades'),
    url(r'^project/(?P<pk>[0-9]+)/ready/$', views.ready, name='ready'),
    
    url(r'^project/(?P<pk>[0-9]+)/events/$', views.events, name='events'),
    url(r'^project/(?P<pk>[0-9]+)/event_detail/(?P<event_id>[0-9]+)/$', views.event_detail, name='event_detail'),
