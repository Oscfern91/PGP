...
urlpatterns = [
    ...
    url(r'^project/(?P<id_proyecto>[0-9]+)/validate_events/(?P<event_id>[0-9]+)/$', views.validate_event, name='validate_event'),
    url(r'^project/(?P<id_proyecto>[0-9]+)/validate_events/$', views.validate_events, name='validate_events'),
    ...
    url(r'^project/(?P<id_proyecto>[0-9]+)/summary/$', views.preview, name='preview'),
